...
public class HeroAbility_PupetterSelf extends HeroAbility {

	public HeroAbility_PupetterSelf(int heroId) {
		super();
		init(heroId, "Мастер кукол");
		setAbilityValue2(0);
	...
	public String getAbilityTip() {
		String htmltext = "";
		htmltext += getName()+": +" + String.format("%.4g%n", getAbilityValue2()*getAbilityValue1())+"мощи ( мощь пожранных трупов "+String.format("%.5g%n", getAbilityValue2())+", "+String.format("%.4g%n", getAbilityValue1()*100)+"% реализовано)";
